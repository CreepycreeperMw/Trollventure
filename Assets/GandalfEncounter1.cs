...
public class GandalfEncounter1 : MonoBehaviour
{
    ...
    private IEnumerator OnTriggerEnter2D(Collider2D collision)
    {
        if(!triggered && collision.gameObject.CompareTag("player"))
        {
            ...
            MusicHandler.handler.Fade(2f, 0f, 0f);
            ...
            tb.Setup("Ich kann hier keine Störenfriede gebrauchen\n-_-", offset);
            yield return new WaitForSeconds(3.5f);
            tb.Setup("Weißt du was?", offset);
            ...
            yield return new WaitForSeconds(3.5f);
            tb.Setup("Gute deutsche Qualität versteht sich...", offset);
            yield return new WaitForSeconds(2f);
